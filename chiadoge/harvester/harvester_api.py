...
from chiadoge.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from chiadoge.harvester.harvester import Harvester
from chiadoge.plotting.plot_tools import PlotInfo, parse_plot_info
from chiadoge.protocols import harvester_protocol
from chiadoge.protocols.farmer_protocol import FarmingInfo
from chiadoge.protocols.protocol_message_types import ProtocolMessageTypes
from chiadoge.server.outbound_message import make_msg
...
from chiadoge.util.api_decorators import api_request, peer_required
from chiadoge.util.ints import uint8, uint32, uint64
from chiadoge.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSChiadogeConnection
    ):
        """
