...
from chiadoge.types.blockchain_format.program import Program, INFINITE_COST
from chiadoge.types.condition_opcodes import ConditionOpcode
from chiadoge.types.spend_bundle import SpendBundle
from chiadoge.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "chiadoge" in cc_discrepancies:
                    cc_discrepancies["chiadoge"] = cc_discrepancies["chiadoge"] + diff
                else:
                    cc_discrepancies["chiadoge"] = diff
