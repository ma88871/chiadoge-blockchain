...
from chiadoge.server.ssl_context import chiadoge_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"chiadoge_{service_name}"
        ...
        chiadoge_ca_crt, chiadoge_ca_key = chiadoge_ssl_ca_paths(root_path, self.config)
        inbound_rlp = self.config.get("inbound_rate_limit_percent")
        outbound_rlp = self.config.get("outbound_rate_limit_percent")
        assert inbound_rlp and outbound_rlp
        self._server = ChiadogeServer(
            advertised_port,
            node,
            peer_api,
            node_type,
            ...
            (chiadoge_ca_crt, chiadoge_ca_key),
    ...
    async def wait_closed(self) -> None:
        ...
        self._log.info("Waiting for ChiadogeServer to be closed")
