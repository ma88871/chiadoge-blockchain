...
from chiadoge.cmds.configure import configure_cmd
from chiadoge.cmds.farm import farm_cmd
from chiadoge.cmds.init import init_cmd
from chiadoge.cmds.keys import keys_cmd
from chiadoge.cmds.netspace import netspace_cmd
from chiadoge.cmds.plots import plots_cmd
from chiadoge.cmds.show import show_cmd
from chiadoge.cmds.start import start_cmd
from chiadoge.cmds.stop import stop_cmd
from chiadoge.cmds.wallet import wallet_cmd
...
@click.group(
    help=f"\n  Manage chiadoge blockchain infrastructure ({__version__})\n",
    epilog="Try 'chiadoge start node', 'chiadoge netspace -d 192', or 'chiadoge show -s'",
...
@cli.command("version", short_help="Show chiadoge version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs chiadoge daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from chiadoge.daemon.server import async_run_daemon
    import asyncio
